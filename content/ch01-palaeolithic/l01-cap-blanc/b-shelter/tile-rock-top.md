# Bedrock tile, surface

| | |
|---|---|
| Id | `tile-rock-top` |
| File | `tile-rock-top.png` (not painted yet: the game draws its own until this file exists) |
| Size | 16 × 16 world px per frame, painted 64 × 64 |
| Beat | `b-shelter` |

## What it is

Bedrock with a worn floor surface on top.

## Where it stands in the game

Where the hiker walks on rock.

## Must be right

Tiles seamlessly with `tile-rock`.
