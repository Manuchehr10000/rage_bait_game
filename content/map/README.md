...
| 12 | HMS Victory | Three masts, and the black-and-yellow chequer Nelson had her painted in, which is why the gunports read as squares along the side. The weakest of the twelve: it is a ship and the rest of the game is buildings. A Martello tower is more on theme and reads as a featureless drum; say the word and it changes. |
